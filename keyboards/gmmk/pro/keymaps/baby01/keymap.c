...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [0] = LAYOUT(
        KC_ESC,       KC_SLCK, KC_PAUS, LCTL(KC_UP),   LCTL(KC_DOWN), KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_MUTE, KC_VOLD, KC_VOLU, KC_SLEP, KC_MUTE,
        ...
        KC_LCTL,      KC_LALT, KC_LGUI,                                        KC_SPC,                             MO(1),   KC_RGUI, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [1] = LAYOUT(
